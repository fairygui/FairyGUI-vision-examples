...
void TreeViewScene::continueInit()
{
    ...
    _treeView->addListener(UIEventType::ClickItem, CALLBACK_1(TreeViewScene::onClickNode, this));
    _treeView->treeNodeRender = CALLBACK_1(TreeViewScene::renderTreeNode, this);
    ...
    ValueVector vv;
    vv.push_back(Value("I'm a top node too"));
    vv.push_back(Value("ui://TreeView/heart"));
    anotherTopNode->setData(Value(vv));
