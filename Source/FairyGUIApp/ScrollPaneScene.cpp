...
void ScrollPaneScene::continueInit()
{
    ...
    _list->itemRenderer = CALLBACK_2(ScrollPaneScene::renderListItem, this);
    _list->setVirtual();
    _list->setNumItems(1000);
    _list->addListener(UIEventType::TouchBegin, CALLBACK_1(ScrollPaneScene::onClickList, this));
}
...
void ScrollPaneScene::renderListItem(int index, GObject* obj)
{
    ...
    item->getChild("b0")->addClickListener(CALLBACK_1(ScrollPaneScene::onClickStick, this), EventTag(this));
    item->getChild("b1")->addClickListener(CALLBACK_1(ScrollPaneScene::onClickDelete, this), EventTag(this));
}
